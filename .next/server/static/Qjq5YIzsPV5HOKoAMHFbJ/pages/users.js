...
/**
 * @flow
 * @relayHash ed3b2a1948f00c0b9478a1fa109a7365
 */
...
/**
 * @flow
 * @relayHash 023072d6c34759996a2e0b9f7307d51c
 */
...
/**
 * @flow
 * @relayHash 8518aac5ee7a435d68425536af8e4994
 */
...
declare export opaque type UserItemContainer_node$fragmentType: UserItemContainer_node$ref;
...
|};
export type UserItemContainer_node$data = UserItemContainer_node;
export type UserItemContainer_node$key = {
  +$data?: UserItemContainer_node$data,
...
declare export opaque type UserListContainer_viewer$fragmentType: UserListContainer_viewer$ref;
...
|};
export type UserListContainer_viewer$data = UserListContainer_viewer;
export type UserListContainer_viewer$key = {
  +$data?: UserListContainer_viewer$data,
  +$fragmentRefs: UserListContainer_viewer$ref,
};
*/
...
/**
 * @flow
 * @relayHash 458881b39ac6ed214fc733426db81d5e
 */
