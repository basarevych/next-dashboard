...
/**
 * @flow
 * @relayHash 5717e87340a5f0dbb853fff3733b9556
 */
...
declare export opaque type EmployeeListContainer_viewer$fragmentType: EmployeeListContainer_viewer$ref;
...
|};
export type EmployeeListContainer_viewer$data = EmployeeListContainer_viewer;
export type EmployeeListContainer_viewer$key = {
  +$data?: EmployeeListContainer_viewer$data,
  +$fragmentRefs: EmployeeListContainer_viewer$ref,
};
*/
...
/**
 * @flow
 * @relayHash c39d15df21fb76946b86755ab8779eeb
 */
...
/**
 * @flow
 * @relayHash ce6973a9aa42b4039b6d874ff7eb9d38
 */
...
declare export opaque type EmployeeItemContainer_node$fragmentType: EmployeeItemContainer_node$ref;
...
|};
export type EmployeeItemContainer_node$data = EmployeeItemContainer_node;
export type EmployeeItemContainer_node$key = {
  +$data?: EmployeeItemContainer_node$data,
  +$fragmentRefs: EmployeeItemContainer_node$ref,
};
*/
...
/**
 * @flow
 * @relayHash 9fc24a6ad3d58ccb7b5762a5a715edd5
 */
