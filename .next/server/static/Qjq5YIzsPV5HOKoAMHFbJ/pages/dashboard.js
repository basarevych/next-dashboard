...
declare export opaque type DemoListContainer_viewer$fragmentType: DemoListContainer_viewer$ref;
...
|};
export type DemoListContainer_viewer$data = DemoListContainer_viewer;
export type DemoListContainer_viewer$key = {
  +$data?: DemoListContainer_viewer$data,
...
declare export opaque type DemoItemContainer_node$fragmentType: DemoItemContainer_node$ref;
...
|};
export type DemoItemContainer_node$data = DemoItemContainer_node;
export type DemoItemContainer_node$key = {
  +$data?: DemoItemContainer_node$data,
  +$fragmentRefs: DemoItemContainer_node$ref,
};
*/
...
/**
 * @flow
 * @relayHash 4d38ca92324996687411967a64ef1c49
 */
...
/**
 * @flow
 * @relayHash 27063eef8435f0f8fc7dc23c20e96967
 */
...
/**
 * @flow
 * @relayHash 2732b394f6efffbe0029832e7358f6ad
 */
