...
var material = __webpack_require__(114);

var daemon = __webpack_require__(115);
...
var _serialize = _interopRequireDefault(__webpack_require__(111));

var _deserialize = _interopRequireDefault(__webpack_require__(112));

var _getMaterialContext = _interopRequireDefault(__webpack_require__(113));

var _getReduxStore3 = _interopRequireDefault(__webpack_require__(117));
...
function (_App) {
  ...
  _createClass(MyApp, null, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee(_ref) {
        var Component, ctx, _getReduxStore, isCreated, store, req, res, err, query, cookie, status, googleMapsKey, statusCode, pageProps;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _getReduxStore = (0, _getReduxStore3.default)(), isCreated = _getReduxStore.isCreated, store = _getReduxStore.store;
                ctx.store = store;
  ...
  function MyApp(props) {
    ...
    var _getReduxStore2 = (0, _getReduxStore3.default)((0, _deserialize.default)(props.state)),
        store = _getReduxStore2.store;

    _this.reduxStore = store;
    store.dispatch(_app2.appOperations.init()).catch(console.error);

    if (props.locale !== _app2.appSelectors.getLocale(store.getState())) {
...
var _themes = _interopRequireDefault(__webpack_require__(99));
