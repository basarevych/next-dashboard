...
var _reducers = _interopRequireDefault(__webpack_require__(34));

var authTypes = _interopRequireWildcard(__webpack_require__(13));

exports.authTypes = authTypes;

var authOperations = _interopRequireWildcard(__webpack_require__(35));
...
var appOperations = _interopRequireWildcard(__webpack_require__(30));

exports.appOperations = appOperations;

var appSelectors = _interopRequireWildcard(__webpack_require__(17));
...
var moment = __webpack_require__(33); // Add locales:
...
module.exports = {
  ...
  messages: {
    en: parse(__webpack_require__(26)),
    ru: parse(__webpack_require__(27))
  },
...
var _locales = _interopRequireDefault(__webpack_require__(21));
...
var _Fetcher = _interopRequireDefault(__webpack_require__(37));

var _Storage = _interopRequireDefault(__webpack_require__(38));

var _Socket = _interopRequireDefault(__webpack_require__(39));

var _Cookie = _interopRequireDefault(__webpack_require__(42));
        ...
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                if (!selectors.getService(getState(), {
                  service: "di"
                })) {
                  _context2.next = 2;
                  break;
...
var actions = _interopRequireWildcard(__webpack_require__(36));
...
var _package = _interopRequireDefault(__webpack_require__(41));
...
exports.getEditModalData = exports.isEditModalOpen = exports.getNumSelected = exports.getSelected = void 0;
...
var _Errors = _interopRequireDefault(__webpack_require__(23));
...
var _reducers = _interopRequireDefault(__webpack_require__(86));

var dashboardTypes = _interopRequireWildcard(__webpack_require__(63));

exports.dashboardTypes = dashboardTypes;

var dashboardOperations = _interopRequireWildcard(__webpack_require__(87));
...
var _reducers = _interopRequireDefault(__webpack_require__(89));

var usersTypes = _interopRequireWildcard(__webpack_require__(50));

exports.usersTypes = usersTypes;

var usersOperations = _interopRequireWildcard(__webpack_require__(90));

exports.usersOperations = usersOperations;

var usersSelectors = _interopRequireWildcard(__webpack_require__(64));
...
var selectors = _interopRequireWildcard(__webpack_require__(64));
...
var _relayRuntime = __webpack_require__(85);
...
var material = __webpack_require__(120);
...
var _app = _interopRequireWildcard(__webpack_require__(113));
...
var _CssBaseline = _interopRequireDefault(__webpack_require__(114));

var _jssExtend = _interopRequireDefault(__webpack_require__(115));

var _JssProvider = _interopRequireDefault(__webpack_require__(116));

var _serialize = _interopRequireDefault(__webpack_require__(117));

var _deserialize = _interopRequireDefault(__webpack_require__(118));

var _getMaterialContext = _interopRequireDefault(__webpack_require__(119));

var _getReduxStore = _interopRequireDefault(__webpack_require__(123));

var _getRelayEnvironment = _interopRequireDefault(__webpack_require__(127));

var _app2 = __webpack_require__(10);
...
var _Relay = __webpack_require__(92);

var _Intl = _interopRequireDefault(__webpack_require__(128));

var _Date = _interopRequireDefault(__webpack_require__(130));

var _Layout = _interopRequireDefault(__webpack_require__(134));
...
function (_App) {
  ...
  _createClass(MyApp, null, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee(_ref) {
        var Component, ctx, req, res, err, query, store, statusCode, csrf, status, googleMapsKey, relayEnvironment, pageProps;
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                store = (0, _getReduxStore.default)();
              ...
              case 15:
                _context.next = 17;
                return store.dispatch(_app2.appOperations.init({
                  cookie: clientCookies
                }));

              case 17:
                relayEnvironment = (0, _getRelayEnvironment.default)(store);
                ctx.statusCode = statusCode;
                ctx.store = store;
                ctx.fetchQuery = (0, _Relay.fetchQuery)(relayEnvironment);
                pageProps = {};
              ...
              case 26:
                return _context.abrupt("return", {
                  ...
                  relayState: (0, _serialize.default)(relayEnvironment.getStore().getSource().toJSON(), "relay")
                });
  ...
  function MyApp(props) {
    ...
    _this.reduxStore = (0, _getReduxStore.default)((0, _deserialize.default)(props.reduxState, "redux"));

    _this.reduxStore.dispatch(_app2.appOperations.init({
      cookie: clientCookies
    }));

    _this.relayEnvironment = (0, _getRelayEnvironment.default)(_this.reduxStore, (0, _deserialize.default)(props.relayState, "relay"));
    _this.materialContext = (0, _getMaterialContext.default)(props.theme);

    if (props.locale !== _app2.appSelectors.getLocale(_this.reduxStore.getState())) {
      _this.reduxStore.dispatch(_app2.appOperations.setLocale({
        locale: props.locale
      }));
    }
...
var pako = __webpack_require__(101);
...
var _themes = _interopRequireDefault(__webpack_require__(105));
...
var _dashboard = _interopRequireDefault(__webpack_require__(83));

var _users = _interopRequireDefault(__webpack_require__(84));
...
var storeFactory = function storeFactory(initialState) {
  return (0, _redux.createStore)(rootReducer, initialState || undefined, middleware);
};

var __NEXT_REDUX_STORE__ = "__NEXT_REDUX_STORE__";

function getReduxStore(initialState) {
  var store;
...
var envFactory = function envFactory(reduxStore, initialState) {
  var fetcher = _app.appSelectors.getService(reduxStore.getState(), {
    service: "fetcher"
  });

  var network = _relayRuntime.Network.create(fetcher.query.bind(fetcher));

  var store = new _relayRuntime.Store(new _relayRuntime.RecordSource(initialState ? initialState.records : undefined));
  var env = new _relayRuntime.Environment({
    network: network,
    store: store
  });

  var di = _app.appSelectors.getService(reduxStore.getState(), {
    service: "di"
  });
...
function getRelayEnviroment(reduxStore, initialState) {
...
var _Intl = _interopRequireDefault(__webpack_require__(129));
...
var _Date = _interopRequireDefault(__webpack_require__(131));
...
var _materialUiPickers = __webpack_require__(132);

var _moment = _interopRequireDefault(__webpack_require__(133));
...
var _head = _interopRequireDefault(__webpack_require__(136));

var _reactIntl = __webpack_require__(6);

var _styles = __webpack_require__(3);

var _CircularProgress = _interopRequireDefault(__webpack_require__(137));

var _Hidden = _interopRequireDefault(__webpack_require__(65));

var _Drawer = _interopRequireDefault(__webpack_require__(138));

var _SwipeableDrawer = _interopRequireDefault(__webpack_require__(139));

var _Sidebar = _interopRequireDefault(__webpack_require__(140));

var _Header = _interopRequireDefault(__webpack_require__(152));

var _AppAuthModal = _interopRequireDefault(__webpack_require__(168));

__webpack_require__(175);

var _styledScroll = _interopRequireDefault(__webpack_require__(177));
...
var _Sidebar = _interopRequireDefault(__webpack_require__(141));
...
var _MenuList = _interopRequireDefault(__webpack_require__(142));
...
var _Dashboard = _interopRequireDefault(__webpack_require__(143));

var _Ballot = _interopRequireDefault(__webpack_require__(144));

var _InsertChart = _interopRequireDefault(__webpack_require__(145));

var _TableChart = _interopRequireDefault(__webpack_require__(146));

var _Map = _interopRequireDefault(__webpack_require__(147));

var _SpeakerNotes = _interopRequireDefault(__webpack_require__(148));

var _BrightnessAuto = _interopRequireDefault(__webpack_require__(149));

var _Pets = _interopRequireDefault(__webpack_require__(150));
...
var _Header = _interopRequireDefault(__webpack_require__(153));
...
var _AppBar = _interopRequireDefault(__webpack_require__(154));

var _Toolbar = _interopRequireDefault(__webpack_require__(155));

var _Button = _interopRequireDefault(__webpack_require__(43));

var _IconButton = _interopRequireDefault(__webpack_require__(156));

var _InputBase = _interopRequireDefault(__webpack_require__(157));

var _Menu = _interopRequireDefault(__webpack_require__(158));
...
var _ListItemAvatar = _interopRequireDefault(__webpack_require__(159));

var _Avatar = _interopRequireDefault(__webpack_require__(160));

var _Badge = _interopRequireDefault(__webpack_require__(161));

var _Search = _interopRequireDefault(__webpack_require__(162));

var _Mail = _interopRequireDefault(__webpack_require__(163));

var _AccountBox = _interopRequireDefault(__webpack_require__(164));

var _ColorLens = _interopRequireDefault(__webpack_require__(165));

var _PowerSettingsNew = _interopRequireDefault(__webpack_require__(166));

var _reactFlags = _interopRequireDefault(__webpack_require__(167));
...
var _AppAuthModal = _interopRequireDefault(__webpack_require__(169));
...
var _Paper = _interopRequireDefault(__webpack_require__(94));

var _Typography = _interopRequireDefault(__webpack_require__(51));

var _Hidden = _interopRequireDefault(__webpack_require__(65));

var _VisibilityOff = _interopRequireDefault(__webpack_require__(170));
...
var _facebook = _interopRequireDefault(__webpack_require__(171));

var _google = _interopRequireDefault(__webpack_require__(172));

var _twitter = _interopRequireDefault(__webpack_require__(173));

var _auth = _interopRequireDefault(__webpack_require__(174));
