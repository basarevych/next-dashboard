...
/******/ 	return __webpack_require__(__webpack_require__.s = "6073");
/******/ })
/************************************************************************/
/******/ ({
...
var _reactGoogleMaps = __webpack_require__("9Tpg");
...
function (_React$PureComponent) {
  ...
  function Map() {
    ...
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(Map).apply(this, arguments));
  }
...
(0, _defineProperty2.default)(Map, "pointShape", _propTypes.default.shape({
  lat: _propTypes.default.number.isRequired,
  lng: _propTypes.default.number.isRequired
}));
(0, _defineProperty2.default)(Map, "defaultProps", {
  zoom: 14
});
var _default = Map;
exports.default = _default;
...
var _Map = _interopRequireDefault(__webpack_require__("679M"));

var Map = (0, _reactGoogleMaps.withScriptjs)((0, _reactGoogleMaps.withGoogleMap)(_Map.default));

var mapStateToProps = function mapStateToProps(state) {
  return {
    googleMapsKey: _state.authSelectors.getGoogleMapsKey(state)
  };
};

var MapContainer = (0, _reactRedux.connect)(mapStateToProps, null)(function (_ref) {
  var width = _ref.width,
      height = _ref.height,
      googleMapsKey = _ref.googleMapsKey,
      props = (0, _objectWithoutProperties2.default)(_ref, ["width", "height", "googleMapsKey"]);
  return _react.default.createElement(Map, (0, _extends2.default)({
...
MapContainer.propTypes = (0, _objectSpread2.default)({}, _Map.default.propTypes, {
...
var _MapsPage = _interopRequireWildcard(__webpack_require__("uqle"));

var MapsPage = (0, _styles.withStyles)(_MapsPage.styles)(_MapsPage.default);
MapsPage.getInitialProps = _MapsPage.default.getInitialProps;
...
var _MapsPageContainer = _interopRequireDefault(__webpack_require__("VLZ1"));
...
var _MapContainer = _interopRequireDefault(__webpack_require__("F72/"));
  ...
  (0, _createClass2.default)(MapsPage, [{
    ...
    value: function render() {
      return _react.default.createElement("div", {
        ...
        var width = _ref.width,
            height = _ref.height;
        return _react.default.createElement(_MapContainer.default, {
          width: width,
          height: height,
          center: {
            lat: 53.342686,
