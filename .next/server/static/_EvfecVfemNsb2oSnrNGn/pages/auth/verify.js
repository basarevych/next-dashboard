...
/******/ 	return __webpack_require__(__webpack_require__.s = "276c");
/******/ })
/************************************************************************/
/******/ ({
...
var _VerifyPageContainer = _interopRequireDefault(__webpack_require__("H1k1"));
...
var _VerifyPage = _interopRequireWildcard(__webpack_require__("KE45"));

var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    onVerify: function onVerify(token) {
      return dispatch(_state.authOperations.finishEmailVerification({
        token: token
      }));
    }
  };
...
var VerifyPage = (0, _styles.withStyles)(_VerifyPage.styles)((0, _reactRedux.connect)(null, mapDispatchToProps)(_VerifyPage.default));
VerifyPage.getInitialProps = _VerifyPage.default.getInitialProps;
...
function (_React$Component) {
  (0, _inherits2.default)(VerifyPage, _React$Component);
  (0, _createClass2.default)(VerifyPage, null, [{
    key: "getInitialProps",
  ...
  function VerifyPage(props) {
    ...
    (0, _classCallCheck2.default)(this, VerifyPage);
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(VerifyPage).call(this, props));
    _this.state = {
      message: null
    };
  ...
  (0, _createClass2.default)(VerifyPage, [{
    key: "handleSubmit",
    value: function () {
